...
public class AlbumServiceExtraerZipTest {
    ...
    void setUp() throws IOException {
        ...
        // Instancia de tu clase a probar
        albumService = new AlbumService(null, null, null, null);
        // 👆 si tu constructor requiere repositorios o dependencias, puedes pasar null
        // porque el método extraerZip no usa ninguna de ellas.
    }
    ...
    // ⚠️ Caso 2: ZIP vacío → retorna mapa vacío
    @Test
